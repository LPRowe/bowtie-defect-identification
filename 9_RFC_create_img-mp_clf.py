...
if seeking:
    ...
    param_grid={'max_depth':[8],
                ...
                'min_samples_leaf':[9],
                'max_features':['log2'],
                'pool_side_length':[2,4]
                }
    
    pipeline=Pipeline([('Max_Pooling',dp.max_pooling(pool_side_length=param_grid['pool_side_length'],image_side_length=8)),
    ...
    grid_search.fit(pipeline.fit_transform(X_train,pool_side_length=param_grid['pool_side_length']),y_train)
    
    params=grid_search.best_params_
    
    X_train_trans=pipeline.fit_transform(X_train,pool_side_length=params['pool_side_length'])
...
if final_params_selected:
    joblib.dump(clf,"C:\\Users\\Logan Rowe\\Desktop\\bowtie-defect-identification\\classifiers\\RF_img-mp_classifier")

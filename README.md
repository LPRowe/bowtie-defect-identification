...
1. Generates annotated images of 5x IR-GFP images to facilitate the process of manually identifying bowties to train the machine learning classifier.  The procedure of doing so is as follows:
    ...
    1. Look through the images generated by script 5 for bowties and non-bowties
    ...
    1. Note each bowtie and non-bowtie in the respective file by {image location},{sub-image location} (see the example .txt file for wafer 50)
